...
var ChannelController = /** @class */ (function () {
    function ChannelController(channelManagerService) {
        this.channelManagerService = channelManagerService;
    }
    ChannelController.prototype.getChannel = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.channelManagerService.findChanAll()];
            });
        });
    };
    ChannelController.prototype.createChan = function (channelDto) {
        return this.channelManagerService.createChan(channelDto);
    };
    __decorate([
        (0, common_1.Get)()
    ], ChannelController.prototype, "getChannel");
    __decorate([
        (0, common_1.Post)(),
        __param(0, (0, common_1.Body)())
    ], ChannelController.prototype, "createChan");
