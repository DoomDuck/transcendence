...
GSettings.BAR_UP_KEYS = ["ArrowUp", "w", "z"];
GSettings.BAR_DOWN_KEYS = ["ArrowDown", "s"];
GSettings.BAR_COLOR = 0xd14081;
...
GSettings.BALL_CLIENT_SERVER_LERP_DIST = 0.05;
GSettings.BALL_CLIENT_SERVER_LERP_FACTOR = 0.05;
GSettings.BALL_COLOR = 0xffffff;
var PlayerID;
(function (PlayerID) {
...
GameEvent.RECEIVE_BAR_KEYDOWN_SERVER = "receiveBarKeydownServer";
GameEvent.RECEIVE_BAR_KEYUP_SERVER = "receiveBarKeyupServer";
