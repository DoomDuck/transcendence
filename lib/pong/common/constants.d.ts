export declare class GSettings {
    ...
    static readonly BAR_UP_KEYS: string[];
    static readonly BAR_DOWN_KEYS: string[];
    static readonly BAR_COLOR = 13713537;
    ...
    static readonly BALL_COLOR = 16777215;
}
...
export declare type BarKeyDownEvent = [KeyValue, number];
export declare type BarKeyUpEvent = [KeyValue, number];
