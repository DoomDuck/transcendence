...
import { Bar } from "./Bar";
import { type BallBarCollisionData, ballBarCollisionDetection, ballBarCollisionDistanceData } from "./collision";
...
export class NonPhysicBall extends Ball {
    ...
    handleBarCollision(bar: Bar): boolean {
        const collision = ballBarCollisionDetection(this, bar);
        if (collision.ignore)
            return false;
