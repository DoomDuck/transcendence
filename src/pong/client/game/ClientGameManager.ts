...
export class ClientGameManagerOnline extends ClientGameManager {
    ...
    setup(socket: Socket, playerId: number) {
        ...
        window.addEventListener('keydown', (e: KeyboardEvent) => handleKeyOnline(e, this.game.state, playerId, socket, true), false);
        window.addEventListener('keyup', (e: KeyboardEvent) => handleKeyOnline(e, this.game.state, playerId, socket, false), false);
    }
}
