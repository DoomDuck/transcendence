...
export class ServerGame extends Game {
  constructor() {
    ...
    this.onIn(
      ...
      (playerId: PlayerID, ...args: BarKeyDownEvent) =>
        this.state.bars[playerId].onReceiveKeydown(...args)
    );
    this.onIn(
      GameEvent.RECEIVE_BAR_KEYUP,
      (playerId: PlayerID, ...args: BarKeyDownEvent) =>
        this.state.bars[playerId].onReceiveKeyup(...args)
    );
    // Game loop
