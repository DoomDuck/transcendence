...
export class GameManager {
  ...
  constructor(private players: [Socket, Socket]) {
    ...
    this.game.onOut(GameEvent.GOAL, (playerId: PlayerID) =>
      this.handleGoal(playerId)
    );
    this.game.onOut(GameEvent.SEND_SET_BALL, (...args: any[]) =>
      this.broadcastEvent(GameEvent.RECEIVE_SET_BALL, ...args)
    );
  }
